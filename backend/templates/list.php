...
<body>
	...
	<div class="admin-content">
		...
		<div class="aright">
			<a href="<?php Setting::uri(); ?>manager/template/add" class="add-button">Добавить</a>
		</div>
		<div class="clear"></div>
			...
			<div class="admin-item">
				<div class="col-7">
					<div class="admin-title">
						<a href="<?php Setting::uri(); ?>manager/template/update/<?php echo $item["id"]; ?>">
							<?php echo $item["title"]; ?>
						</a>
					</div>
					<div class="control-links">
						<a href="<?php Setting::uri(); ?>manager/template/update/<?php echo $item["id"]; ?>"><i class="icon-pencil"></i> Редактировать</a>
						<a href="#delete<?php echo $item["id"]; ?>" class="delete"><i class="icon-close"></i> Удалить</a>
					</div>
				</div>
				<div class="pub-2 col-3">
					Предназначен для:<br>
					<a><?php echo $item["company_type_title"]; ?></a>
				</div>
				<div class="pub-2 col-2">
					Период:<br>
					<a><?php echo $item["period_title"]; ?></a>
				</div>
				<div class="clear"></div>
			</div>
			  ...
			  <div class="modal-dialog">
			    <div class="modal-content">
			      ...
			      <div class="modal-body">
			      	<a href="<?php Setting::uri(); ?>manager/template/delete/<?php echo $item["id"]; ?>" class="btn red">Да</a>
